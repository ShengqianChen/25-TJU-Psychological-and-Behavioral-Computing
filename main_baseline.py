...
parser = argparse.ArgumentParser(description='Baseline Model for Multimodal Sentiment Analysis')
parser.add_argument('-f', default='', type=str)

# Fixed
parser.add_argument('--model', type=str, default='Baseline',
                    help='name of the model to use (Baseline for simple baseline model)')
...
parser.add_argument('--attn_dropout', type=float, default=0.1,
                    help='attention dropout (not used in baseline)')
parser.add_argument('--attn_dropout_a', type=float, default=0.0,
                    help='attention dropout (for audio, not used in baseline)')
parser.add_argument('--attn_dropout_v', type=float, default=0.0,
                    help='attention dropout (for visual, not used in baseline)')
parser.add_argument('--relu_dropout', type=float, default=0.1,
                    help='relu dropout (not used in baseline)')
parser.add_argument('--embed_dropout', type=float, default=0.25,
                    help='embedding dropout')
parser.add_argument('--res_dropout', type=float, default=0.1,
                    help='residual block dropout (not used in baseline)')
parser.add_argument('--out_dropout', type=float, default=0.0,
                    help='output layer dropout')

# Architecture (not all used in baseline)
parser.add_argument('--nlevels', type=int, default=5,
                    help='number of layers in the network (not used in baseline)')
parser.add_argument('--num_heads', type=int, default=5,
                    help='number of heads for the transformer network (not used in baseline)')
parser.add_argument('--attn_mask', action='store_false',
                    help='use attention mask for Transformer (not used in baseline)')
...
parser.add_argument('--name', type=str, default='baseline',
                    help='name of the trial (default: "baseline")')
...
####################################################################
#
# Modified train function to use baseline model
#
####################################################################
...
if __name__ == '__main__':
    print("=" * 50)
    print("Using Simple Baseline Model (MLP Fusion)")
    print("=" * 50)
    test_loss = initiate_baseline(hyp_params, train_loader, valid_loader, test_loader)
