...
from src.models_baseline import MULTModelMLP


parser = argparse.ArgumentParser(description='MulT Baseline (MLP) Training')
parser.add_argument('-f', default='', type=str)

# Fixed
parser.add_argument('--model', type=str, default='MulTBaseline',
                    help='name of the model to use (default: MulTBaseline)')
...
parser.add_argument('--name', type=str, default='mult_baseline',
                    help='name of the trial (default: "mult_baseline")')
...
def build_training_settings(model, hyp_params):
...
if __name__ == '__main__':
    baseline_model = MULTModelMLP(hyp_params)
    if hyp_params.use_cuda:
        baseline_model = baseline_model.cuda()

    settings = build_training_settings(baseline_model, hyp_params)
    train.train_model(settings, hyp_params, train_loader, valid_loader, test_loader)
